	...
	<div class="navbar navbar-default">
		...
		<div class="navbar-collapse collapse navbar-responsive-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="student.html">Student Add</a></li>
				<li><a href="success.html">List</a></li>
			</ul>
		</div>
		<!-- /.nav-collapse -->
	</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post"
							...
							<fieldset>
								<legend>Electronic School Student Adding Form</legend>

								<div class="form-group">
									<label for="userNameInput" class="col-lg-3 control-label">Student's
										User Name</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label for="confirmPasswordInput" class="col-lg-3 control-label">Confirm Password</label>
									<div class="col-lg-9">
										<form:input type="password" class="form-control"
											path="confirmPassword" id="confirmPasswordInput" placeholder="Confirm Password" />
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h3>Student Adding Form Submission</h3>
												</div>
